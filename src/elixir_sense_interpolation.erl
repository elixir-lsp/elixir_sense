...
%
% https://github.com/elixir-lang/elixir/blob/v1.13.4/lib/elixir/src/elixir_interpolation.erl
%
...
-module(elixir_sense_interpolation).
-export([extract/6, unescape_string/1, unescape_string/2,
unescape_tokens/1, unescape_map/1]).
-include("elixir_sense.hrl").
-include("elixir_sense_tokenizer.hrl").
