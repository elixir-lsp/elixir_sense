...
#
# https://github.com/elixir-lang/elixir/blob/v1.13/lib/elixir/test/code_fragment.exs
#
...
# code taken from 1.13.1 (33f9d04851a2664aeae5f5f78eeef9e5b4c38030)

defmodule ElixirSense.Core.Normalized.Code.CursorContextTest do
  use ExUnit.Case, async: true
  alias ElixirSense.Core.Normalized.Code.CursorContext, as: CF
