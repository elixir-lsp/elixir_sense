defmodule ElixirSense.Providers.Plugins.Ecto do
  @moduledoc false

  alias ElixirSense.Providers.Plugins.ModuleStore
  alias ElixirSense.Core.Source
  alias ElixirSense.Providers.Plugins.Ecto.Query
  alias ElixirSense.Providers.Plugins.Ecto.Schema
  alias ElixirSense.Providers.Plugins.Ecto.Types

  @behaviour ElixirSense.Providers.Plugin
  use ElixirSense.Providers.Completion.GenericReducer
