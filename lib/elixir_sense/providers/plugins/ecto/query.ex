defmodule ElixirSense.Providers.Plugins.Ecto.Query do
  @moduledoc false

  alias ElixirSense.Core.Introspection
  alias ElixirSense.Core.Source
  alias ElixirSense.Providers.Plugins.Util
  ...
  defp clauses_suggestions(hint) do
    funs = ElixirSense.Providers.Completion.CompletionEngine.get_module_funs(Ecto.Query, false)
